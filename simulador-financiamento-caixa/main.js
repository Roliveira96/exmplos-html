...
const adicionarIntegrante = (nome = '', dtNasc = '', salario = 0, fgtsAcumulado = 0, tem3AnosFgts = true, usarFgtsFuturo = true) => {
    ...
    novoIntegrante.innerHTML = `
        <div class="flex justify-between items-center">
            <h3 id="proponenteTitulo-${integranteId}" class="proponente-title font-semibold text-indigo-700">Proponente ${integranteId}</h3>
        ...
        <div class="grid grid-cols-2 gap-3">
            <div>
                ...
                <input type="text" value="${nome}" placeholder="Nome Proponente" class="integrante-nome mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 text-sm border" oninput="atualizarTituloProponente(${integranteId})">
            </div>
             <div>
